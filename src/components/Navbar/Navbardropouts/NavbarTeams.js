...
const NavbarTeams = (props) => {
    return (
        <div
            className="flex justify-center items-center container mx-auto px-1   h-auto px-2 ">
            <div className="text-amber-50 container flex justify-around  flex-row divide-x divide-solid items-center">
                <button onClick={() => props.setTeam("administration")}
                        className="flex-1 justify-center items-center p-5 border-amber-50  border rounded-2xl hover:bg-amber-100 hover:text-black focus:text-black focus:bg-amber-100">
                    Administration
                </button>
